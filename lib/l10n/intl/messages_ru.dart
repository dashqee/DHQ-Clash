...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(attempt, total) =>
      "Подключение… попытка ${attempt} из ${total}";
  ...
  static String m23(shown, total) => "Показано ${shown} из ${total}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "connectingAttempt": m0,
    "connection": MessageLookupByLibrary.simpleMessage("Соединение"),
    "connections": MessageLookupByLibrary.simpleMessage("Активные соединения"),
    ...
    "findProcessModeTunnelLocked": MessageLookupByLibrary.simpleMessage(
      "Требуется аварийному туннелю, пока он включён",
    ),
    ...
    "latestVersion": MessageLookupByLibrary.simpleMessage("Последняя версия"),
    "launchFailedConfig": MessageLookupByLibrary.simpleMessage(
      "Не удалось загрузить профиль в ядро. Проверьте профиль и попробуйте ещё раз.",
    ),
    "launchFailedCore": MessageLookupByLibrary.simpleMessage(
      "Не удалось запустить ядро. Попробуйте ещё раз; на Windows может помочь «Настройки → Сеть → переустановить службу».",
    ),
    "launchFailedTunnel": MessageLookupByLibrary.simpleMessage(
      "TUN-устройство не поднялось, трафик не заворачивается. VPN остановлен. Попробуйте ещё раз.",
    ),
    "launchFailedVpn": MessageLookupByLibrary.simpleMessage(
      "VPN-сервис не запустился. VPN остановлен. Попробуйте ещё раз.",
    ),
    ...
    "requests": MessageLookupByLibrary.simpleMessage("История запросов"),
    ...
    "ruleSetContent": MessageLookupByLibrary.simpleMessage("Содержимое"),
    "ruleSetLoadFailed": MessageLookupByLibrary.simpleMessage(
      "Не удалось прочитать набор правил",
    ),
    "ruleSetShownCount": m23,
    ...
    "turnTunnelPinnedDesc": MessageLookupByLibrary.simpleMessage(
      "Пока аварийный туннель подключён, весь трафик идёт в него. Выключите тумблер, чтобы вернуть обычную маршрутизацию.",
    ),
    "turnTunnelPinnedModeLocked": MessageLookupByLibrary.simpleMessage(
      "Режим удерживается на «Правилах», пока весь трафик идёт через аварийный туннель.",
    ),
    ...
    "vpnPermissionDenied": MessageLookupByLibrary.simpleMessage(
      "Разрешение на VPN не выдано. Разрешите его при запросе, чтобы подключиться.",
    ),
