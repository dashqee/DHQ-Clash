...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(attempt, total) => "接続中… ${total} 回中 ${attempt} 回目";
  ...
  static String m23(shown, total) => "${total} 件中 ${shown} 件を表示";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "launchFailedConfig": MessageLookupByLibrary.simpleMessage(
      "プロファイルをコアに読み込めませんでした。プロファイルを確認して再試行してください。",
    ),
    "launchFailedCore": MessageLookupByLibrary.simpleMessage(
      "コアを起動できませんでした。再試行してください。Windows では「設定 → ネットワーク → サービスを再インストール」が役立つ場合があります。",
    ),
    "launchFailedTunnel": MessageLookupByLibrary.simpleMessage(
      "TUN デバイスが起動せず、トラフィックは転送されません。VPN は停止しました。再試行してください。",
    ),
    "launchFailedVpn": MessageLookupByLibrary.simpleMessage(
      "VPN サービスが起動しませんでした。VPN は停止しました。再試行してください。",
    ),
    ...
    "vpnPermissionDenied": MessageLookupByLibrary.simpleMessage(
      "VPN の許可が得られませんでした。接続時に求められたら許可してください。",
    ),
    ...
    "windowsTunHelperDesc": MessageLookupByLibrary.simpleMessage(
      "旧バージョンの FlClash と DHQClash が作成したヘルパーサービスを検索して削除し、現在のサービスをインストールします。",
    ),
    ...
    "windowsTunHelperReinstallFailed": MessageLookupByLibrary.simpleMessage(
      "Windows TUN ヘルパーを再インストールできませんでした",
    ),
