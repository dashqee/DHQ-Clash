...
mixin _$AppSettingProps {
 ...
 String? get locale;@JsonKey(fromJson: dashboardWidgetsSafeFormJson) List<DashboardWidget> get dashboardWidgets; bool get onlyStatisticsProxy; bool get autoLaunch; bool get silentLaunch; bool get autoRun; bool get openLogs; bool get closeConnections; String get testUrl; bool get isAnimateToPage; bool get autoCheckUpdate; UpdateChannel get updateChannel; bool get updateChannelExplicit; bool get showLabel; bool get disclaimerAccepted; bool get crashlyticsTip; bool get crashlytics; bool get minimizeOnExit; bool get hidden; bool get developerMode; RestoreStrategy get restoreStrategy; bool get showTrayTitle; String get customUserAgent;
...
@useResult
$Res call({
 String? locale,@JsonKey(fromJson: dashboardWidgetsSafeFormJson) List<DashboardWidget> dashboardWidgets, bool onlyStatisticsProxy, bool autoLaunch, bool silentLaunch, bool autoRun, bool openLogs, bool closeConnections, String testUrl, bool isAnimateToPage, bool autoCheckUpdate, UpdateChannel updateChannel, bool updateChannelExplicit, bool showLabel, bool disclaimerAccepted, bool crashlyticsTip, bool crashlytics, bool minimizeOnExit, bool hidden, bool developerMode, RestoreStrategy restoreStrategy, bool showTrayTitle, String customUserAgent
});
...
/// Create a copy of AppSettingProps
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? locale = freezed,Object? dashboardWidgets = null,Object? onlyStatisticsProxy = null,Object? autoLaunch = null,Object? silentLaunch = null,Object? autoRun = null,Object? openLogs = null,Object? closeConnections = null,Object? testUrl = null,Object? isAnimateToPage = null,Object? autoCheckUpdate = null,Object? updateChannel = null,Object? updateChannelExplicit = null,Object? showLabel = null,Object? disclaimerAccepted = null,Object? crashlyticsTip = null,Object? crashlytics = null,Object? minimizeOnExit = null,Object? hidden = null,Object? developerMode = null,Object? restoreStrategy = null,Object? showTrayTitle = null,Object? customUserAgent = null,}) {
...
as bool,updateChannel: null == updateChannel ? _self.updateChannel : updateChannel // ignore: cast_nullable_to_non_nullable
as UpdateChannel,updateChannelExplicit: null == updateChannelExplicit ? _self.updateChannelExplicit : updateChannelExplicit // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String? locale, @JsonKey(fromJson: dashboardWidgetsSafeFormJson)  List<DashboardWidget> dashboardWidgets,  bool onlyStatisticsProxy,  bool autoLaunch,  bool silentLaunch,  bool autoRun,  bool openLogs,  bool closeConnections,  String testUrl,  bool isAnimateToPage,  bool autoCheckUpdate,  UpdateChannel updateChannel,  bool updateChannelExplicit,  bool showLabel,  bool disclaimerAccepted,  bool crashlyticsTip,  bool crashlytics,  bool minimizeOnExit,  bool hidden,  bool developerMode,  RestoreStrategy restoreStrategy,  bool showTrayTitle,  String customUserAgent)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AppSettingProps() when $default != null:
return $default(_that.locale,_that.dashboardWidgets,_that.onlyStatisticsProxy,_that.autoLaunch,_that.silentLaunch,_that.autoRun,_that.openLogs,_that.closeConnections,_that.testUrl,_that.isAnimateToPage,_that.autoCheckUpdate,_that.updateChannel,_that.updateChannelExplicit,_that.showLabel,_that.disclaimerAccepted,_that.crashlyticsTip,_that.crashlytics,_that.minimizeOnExit,_that.hidden,_that.developerMode,_that.restoreStrategy,_that.showTrayTitle,_that.customUserAgent);case _:
  return orElse();
...
class _AppSettingProps implements AppSettingProps {
  const _AppSettingProps({this.locale = 'ru', @JsonKey(fromJson: dashboardWidgetsSafeFormJson) final  List<DashboardWidget> dashboardWidgets = defaultDashboardWidgets, this.onlyStatisticsProxy = false, this.autoLaunch = true, this.silentLaunch = true, this.autoRun = false, this.openLogs = false, this.closeConnections = true, this.testUrl = defaultTestUrl, this.isAnimateToPage = true, this.autoCheckUpdate = true, this.updateChannel = UpdateChannel.stable, this.updateChannelExplicit = false, this.showLabel = false, this.disclaimerAccepted = false, this.crashlyticsTip = false, this.crashlytics = false, this.minimizeOnExit = true, this.hidden = false, this.developerMode = false, this.restoreStrategy = RestoreStrategy.compatible, this.showTrayTitle = true, this.customUserAgent = ''}): _dashboardWidgets = dashboardWidgets;
...
@override@JsonKey() final  UpdateChannel updateChannel;
@override@JsonKey() final  bool updateChannelExplicit;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,locale,const DeepCollectionEquality().hash(_dashboardWidgets),onlyStatisticsProxy,autoLaunch,silentLaunch,autoRun,openLogs,closeConnections,testUrl,isAnimateToPage,autoCheckUpdate,updateChannel,updateChannelExplicit,showLabel,disclaimerAccepted,crashlyticsTip,crashlytics,minimizeOnExit,hidden,developerMode,restoreStrategy,showTrayTitle,customUserAgent]);
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$VideoCallTunnelPropsCopyWith<VideoCallTunnelProps> get copyWith => _$VideoCallTunnelPropsCopyWithImpl<VideoCallTunnelProps>(this as VideoCallTunnelProps, _$identity);

  /// Serializes this VideoCallTunnelProps to a JSON map.
  Map<String, dynamic> toJson();
...
/// @nodoc
abstract mixin class $VideoCallTunnelPropsCopyWith<$Res>  {
...
/// @nodoc
class _$VideoCallTunnelPropsCopyWithImpl<$Res>
    implements $VideoCallTunnelPropsCopyWith<$Res> {
  _$VideoCallTunnelPropsCopyWithImpl(this._self, this._then);

  final VideoCallTunnelProps _self;
  final $Res Function(VideoCallTunnelProps) _then;
...
/// Adds pattern-matching-related methods to [VideoCallTunnelProps].
extension VideoCallTunnelPropsPatterns on VideoCallTunnelProps {
/// A variant of `map` that fallback to returning `orElse`.
///
/// It is equivalent to doing:
/// ```dart
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _VideoCallTunnelProps value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _VideoCallTunnelProps value)  $default,){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _VideoCallTunnelProps value)?  $default,){
final _that = this;
switch (_that) {
case _VideoCallTunnelProps() when $default != null:
return $default(_that);case _:
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$VideoCallTunnelPropsCopyWith<_VideoCallTunnelProps> get copyWith => __$VideoCallTunnelPropsCopyWithImpl<_VideoCallTunnelProps>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$VideoCallTunnelPropsToJson(this, );
}
...
/// @nodoc
abstract mixin class _$VideoCallTunnelPropsCopyWith<$Res> implements $VideoCallTunnelPropsCopyWith<$Res> {
...
/// @nodoc
class __$VideoCallTunnelPropsCopyWithImpl<$Res>
    implements _$VideoCallTunnelPropsCopyWith<$Res> {
  __$VideoCallTunnelPropsCopyWithImpl(this._self, this._then);

  final _VideoCallTunnelProps _self;
  final $Res Function(_VideoCallTunnelProps) _then;
...
class _ProxiesStyleProps implements ProxiesStyleProps {
  const _ProxiesStyleProps({this.type = ProxiesType.list, this.sortType = ProxiesSortType.none, this.layout = ProxiesLayout.standard, this.iconStyle = ProxiesIconStyle.standard, this.cardType = ProxyCardType.expand});
...
/// Create a copy of Config
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? currentProfileId = freezed,Object? overrideDns = null,Object? hotKeyActions = null,Object? appSettingProps = null,Object? davProps = freezed,Object? networkProps = null,Object? vpnProps = null,Object? videoCallTunnelProps = null,Object? themeProps = null,Object? proxiesStyleProps = null,Object? windowProps = null,Object? patchClashConfig = null,Object? excludeSSIDs = null,}) {
  return _then(_self.copyWith(
...
as VpnProps,videoCallTunnelProps: null == videoCallTunnelProps ? _self.videoCallTunnelProps : videoCallTunnelProps // ignore: cast_nullable_to_non_nullable
as VideoCallTunnelProps,themeProps: null == themeProps ? _self.themeProps : themeProps // ignore: cast_nullable_to_non_nullable
...
@override
@pragma('vm:prefer-inline')
$VideoCallTunnelPropsCopyWith<$Res> get videoCallTunnelProps {
  
  return $VideoCallTunnelPropsCopyWith<$Res>(_self.videoCallTunnelProps, (value) {
    return _then(_self.copyWith(videoCallTunnelProps: value));
  });
}/// Create a copy of Config
/// with the given fields replaced by the non-null parameter values.
@override
...
switch (_that) {
case _Config() when $default != null:
return $default(_that.currentProfileId,_that.overrideDns,_that.hotKeyActions,_that.appSettingProps,_that.davProps,_that.networkProps,_that.vpnProps,_that.videoCallTunnelProps,_that.themeProps,_that.proxiesStyleProps,_that.windowProps,_that.patchClashConfig,_that.excludeSSIDs);case _:
  return orElse();
...
class _Config implements Config {
  const _Config({this.currentProfileId, this.overrideDns = false, final  List<HotKeyAction> hotKeyActions = const [], @JsonKey(fromJson: AppSettingProps.safeFromJson) this.appSettingProps = defaultAppSettingProps, this.davProps, this.networkProps = defaultNetworkProps, this.vpnProps = defaultVpnProps, this.videoCallTunnelProps = defaultVideoCallTunnelProps, @JsonKey(fromJson: ThemeProps.safeFromJson) required this.themeProps, this.proxiesStyleProps = defaultProxiesStyleProps, this.windowProps = defaultWindowProps, this.patchClashConfig = defaultClashConfig, final  List<String> excludeSSIDs = const []}): _hotKeyActions = hotKeyActions,_excludeSSIDs = excludeSSIDs;
...
@override@JsonKey() final  VideoCallTunnelProps videoCallTunnelProps;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,currentProfileId,overrideDns,const DeepCollectionEquality().hash(_hotKeyActions),appSettingProps,davProps,networkProps,vpnProps,videoCallTunnelProps,themeProps,proxiesStyleProps,windowProps,patchClashConfig,const DeepCollectionEquality().hash(_excludeSSIDs));
