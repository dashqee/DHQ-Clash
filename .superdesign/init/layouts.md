...
## `webapp/src/App.tsx`
The complete responsive application shell. It provides Telegram/web authentication gates, sticky header, desktop sidebar, mobile bottom navigation, page heading, and tab routing.
